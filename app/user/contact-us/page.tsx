          ...
          <form className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 px-5 rounded-[10px] bg-[#1c1c1c] text-sm text-white placeholder-gray-500 outline-none border-none focus:border-[#F2482D]"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-5 py-3 rounded-[10px] bg-[#1c1c1c] text-sm text-white placeholder-gray-500 outline-none border-none focus:border-[#F2482D] resize-none"
              />
            </div>
